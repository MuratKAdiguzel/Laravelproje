...
<html lang="en">
  ...
  <form action="<?php echo e(route('verigiris')); ?>" method="POST" enctype="multipart/form-data">
  <?php echo csrf_field(); ?>
  <h4 >"Veri giriş"</h4>
  <div class="-row">
...
</html><?php /**PATH C:\xampp\htdocs\moneokitap\resources\views/welcome.blade.php ENDPATH**/ ?>